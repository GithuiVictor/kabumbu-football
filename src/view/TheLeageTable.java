 ...
 * @author Victor
 */
public class TheLeageTable extends javax.swing.JFrame {

    /**
     * Creates new form TheLeageTable
     */
    public TheLeageTable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("KAMBUMBU FOOTBALL LEAGE TABLE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TheLeageTable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TheLeageTable().setVisible(true);
            }
        });
    }
